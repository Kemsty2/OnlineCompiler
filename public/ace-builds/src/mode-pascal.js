...
var PascalHighlightRules = function() {
    ...
    this.$rules = { start: 
       [ { caseInsensitive: true,
           ...
           regex: '\\b(?:(algorithm|begin|end|functions_and_procedures|function|procedure|if|elif|else|endif|for|endfor|while|endwhile|repeat|until|step|return|array_of_integer|array_of_string|integer|real|boolean|write|read|constants|variables|returns|then))\\b' },
         { caseInsensitive: true,           
           token: 
